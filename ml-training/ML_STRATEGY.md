...
1. Train small transformer to predict next puzzle
2. Validate discovered formula against transformer predictions
...
### Success Criteria
1. **Forward prediction:** 95%+ accuracy on validation set
